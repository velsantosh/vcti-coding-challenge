...
public class CassandraConfig extends AbstractCassandraConfiguration implements CCTConstants {
	...
	@Value("${spring.data.cassandra.parameter-table}")
	private String paramTable;

	@Value("${spring.data.cassandra.output-table}")
